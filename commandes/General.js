...
zokou({ nomCom: "dev", categorie: "General", reaction: "🚘" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "Cadillac Cylee ❤️🧸", numero: "27835039725" },
      { nom: "᚛errrbodyhatescylee ❤️🧸᚜", numero: "" },
      { nom: "Chucky ❤️🧸", numero: "255762190568" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "WELCOME TO LUMIMA-V1 HELP CENTER! ASK FOR HELP FROM ANY OF THE DEVELOPERS BELOW 👾❤️:\n\n";
